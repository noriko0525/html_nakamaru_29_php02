...
<body>
    ...
    <div id="wrapper">
        <h1>おもいできろくかきかえ</h1>
        <div id="cont">
                <div class="title"><p>タイトル</p><input type="text"class="waku" name="title" value="<?=$row["title"]?>"></div>
                <div class="genre"><p>ねんれい</p><input type="text"class="waku" name="genre" value="<?=$row["genre"]?>"></div>
                <div class="star"><p>ばしょ</p><input type="text"class="waku" name="star" value="<?=$row["star"]?>"></div>
                <div class="comment"><p>コメント</p><textarea class="waku" name="comment" id="" cols="40" rows="4"><?=$row["comment"]?></textarea></div>
                <div class="image" style="display:none;"><p>ファイル</p>
                <?php
                    if($row["image"] ==""){
                    $view .="<div>";
                    $view .="<div>88</div>";
